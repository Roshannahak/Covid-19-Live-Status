...
import com.colive.covid19.adapter.DatePickerAdapter;
import com.colive.covid19.adapter.VaccineCenterAdapter;
import com.colive.covid19.model.vaccination.District;
import com.colive.covid19.model.vaccination.DistrictVaccineCenters;
import com.colive.covid19.model.vaccination.Session;
import com.colive.covid19.model.vaccination.State;
import com.colive.covid19.model.vaccination.VaccinationDistricts;
import com.colive.covid19.model.vaccination.VaccinationState;
...
public class VaccinationCenters extends AppCompatActivity implements AdapterView.OnItemClickListener, DatePickerAdapter.Getdate {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        statename = intent.getStringExtra(States.STATE_NAME);
