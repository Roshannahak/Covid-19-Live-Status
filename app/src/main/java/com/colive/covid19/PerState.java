...
public class PerState extends AppCompatActivity {
    ...
    private void handleButtonClicks() {
        vaccinebtn.setOnClickListener(v -> {
            ...
            intent.putExtra(States.STATE_NAME, state_name);
...
//                .pieRadius(100)
    ...
    private void fetchIntentData() {
        ...
        confirmed = intent.getStringExtra(States.CONFIRMED);
        active = intent.getStringExtra(States.ACTIVE);
        recovered = intent.getStringExtra(States.RECOVERED);
        deceased = intent.getStringExtra(States.DECEASED);
        delta_confirmed = intent.getStringExtra(States.DELTA_CONFIRMED);
        delta_recovered = intent.getStringExtra(States.DELTA_RECOVERED);
        delta_deceased = intent.getStringExtra(States.DELTA_DECEASED);
        state_name = intent.getStringExtra(States.STATE_NAME);
        last_update = intent.getStringExtra(States.LAST_UPDATE);
    }
